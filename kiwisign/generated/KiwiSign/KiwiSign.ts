...
export class ContractSigned extends ethereum.Event {
  get params(): ContractSigned__Params {
    return new ContractSigned__Params(this);
  }
}

export class ContractSigned__Params {
  _event: ContractSigned;

  constructor(event: ContractSigned) {
    this._event = event;
  }
...
export class KiwiSign extends ethereum.SmartContract {
  static bind(address: Address): KiwiSign {
    return new KiwiSign("KiwiSign", address);
  }
  ...
  contract_id(): BigInt {
    let result = super.call("contract_id", "contract_id():(uint256)", []);

    return result[0].toBigInt();
  }

  try_contract_id(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("contract_id", "contract_id():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getCurrentContractId(): BigInt {
    let result = super.call(
      "getCurrentContractId",
      "getCurrentContractId():(uint256)",
      []
    );
  ...
  try_getCurrentContractId(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCurrentContractId",
      "getCurrentContractId():(uint256)",
      []
  ...
  createContract(metadata: string, public_key: Address): BigInt {
    let result = super.call(
      "createContract",
      "createContract(string,address):(uint256)",
      [
        ethereum.Value.fromString(metadata),
        ethereum.Value.fromAddress(public_key)
      ]
    );
  ...
  verifySignature(signature: Bytes, id: BigInt, input_cid: string): boolean {
    let result = super.call(
      "verifySignature",
      "verifySignature(bytes,uint256,string):(bool)",
      [
        ethereum.Value.fromBytes(signature),
        ethereum.Value.fromUnsignedBigInt(id),
        ethereum.Value.fromString(input_cid)
      ]
    );
  ...
  getMetadataFromContractId(id: BigInt): string {
    let result = super.call(
      "getMetadataFromContractId",
      "getMetadataFromContractId(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(id)]
    );
  ...
  try_getMetadataFromContractId(id: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "getMetadataFromContractId",
      "getMetadataFromContractId(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(id)]
  ...
  createSignatureHash(signer: Address, id: BigInt): Bytes {
    let result = super.call(
      "createSignatureHash",
      "createSignatureHash(address,uint256):(bytes32)",
      [
  ...
  getSigner(_hash: Bytes, _signature: Bytes): Address {
  ...
  try_getSigner(_hash: Bytes, _signature: Bytes): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getSigner",
